...
export function CreditCardFilters({ accounts, filters, onFilterChange, expandAll, onToggleExpandAll, accountId }: CreditCardFiltersProps) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className={`grid grid-cols-1 md:grid-cols-2 ${accountId ? 'lg:grid-cols-3' : 'lg:grid-cols-4'} gap-4 p-4 border rounded-lg bg-card`}>
        {!accountId && (
        ...
        {filters.viewMode === "monthly" ? (
          <div className={`space-y-2 ${accountId ? 'md:col-span-2' : 'md:col-span-3'}`}>
