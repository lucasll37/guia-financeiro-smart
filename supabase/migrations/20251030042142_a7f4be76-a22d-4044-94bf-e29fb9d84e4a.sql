-- Criar trigger para popular categorias automaticamente em contas Pessoal, Conjugal e Mesada
...
BEGIN
  -- Só processar contas tipo pessoal, conjugal e mesada
...
-- Criar trigger para contas regulares
DROP TRIGGER IF EXISTS tr_seed_regular_account_categories ON accounts;
CREATE TRIGGER tr_seed_regular_account_categories
  AFTER INSERT ON accounts
  FOR EACH ROW
  EXECUTE FUNCTION seed_regular_account_categories();