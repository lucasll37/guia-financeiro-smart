-- Reverter para excluir contas tipo casa do trigger automático
-- Contas casa devem usar a seed gerenciada e só pegar despesas
...
BEGIN
  ...
  -- Contas tipo casa usam a seed gerenciada
